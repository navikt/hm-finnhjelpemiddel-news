...
{
    val newsDto = News(title = "Nyhet 1", description = "Deez nuts", body = "Dette er en nyhet", created = LocalDateTime.now(), publishedFrom = LocalDateTime.now(), publishedTo = LocalDateTime.now(), imageUrl = null)
    ...
    fun postTest() {
        runBlocking {
            val dto = CreateNewsDto(title = "Nyhet 2", description = "ohio", body = "Dette er ny nyhet", publishedFrom = LocalDateTime.now(), publishedTo = LocalDateTime.now(), imageUrl = null)
    ...
    fun putTest() {
        runBlocking {
            val updatedNews = CreateNewsDto(title = "Nyhet oppdatering", description = "oniichan", body = "Dette er en oppdatering", publishedFrom = LocalDateTime.now(), publishedTo = LocalDateTime.now(), imageUrl = null)
    ...
    fun badDeleteTest() {
        runBlocking {
            val dto = CreateNewsDto(title = "Nyhet 3",description = "daddy", body = "Dette er ny nyhet", publishedFrom = LocalDateTime.now(), publishedTo = LocalDateTime.now(), imageUrl = null)
    ...
    fun badPostTest() {
        runBlocking {
            val dto = CreateNewsDto(title = "", description = "", body = "Dette er ny nyhet", publishedFrom = LocalDateTime.now(), publishedTo = LocalDateTime.now(), imageUrl = null)
